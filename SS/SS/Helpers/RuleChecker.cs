...
namespace SS.Helpers
{
    public static class RuleChecker
    {
        ...
        public static returnWrapper initialize(Section aSection, int aSemesterId, List<Section> sectionList, SSSSContext passedContext)
        {
        ...
        public class returnWrapper{
            ...
            public List<string> listOfFlags;
        ...
        //ON INSERT
        public static returnWrapper checkSection()
        {
